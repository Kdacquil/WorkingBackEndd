  ...
  "node_modules/undici/lib/web/fetch/webidl.js"(exports, module) {
    ...
    webidl.converters.BufferSource = function(V, prefix, name, opts) {
      if (types.isAnyArrayBuffer(V)) {
        return webidl.converters.ArrayBuffer(V, prefix, name, __spreadProps(__spreadValues({}, opts), {
          allowShared: false
        }));
      }
      if (types.isTypedArray(V)) {
        return webidl.converters.TypedArray(V, V.constructor, prefix, name, __spreadProps(__spreadValues({}, opts), {
          allowShared: false
        }));
      }
      if (types.isDataView(V)) {
        return webidl.converters.DataView(V, prefix, name, __spreadProps(__spreadValues({}, opts), {
          allowShared: false
        }));
      }
      throw webidl.errors.conversionFailed({
...
*/
//# sourceMappingURL=chunk-D5NCJWRM.js.map
